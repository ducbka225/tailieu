             ...
             @foreach($score as $u)
              <div class="chat_list">
                <div class="chat_people">
                  <div class="chat_img"> <img src="ezuca/images/{{$u->user->avatar}}" alt="sunil"> </div>
                  <div class="chat_ib">
                      <a href="/chatfriend/{{$u->user->id}}">
                          <h5>{{$u->user->name}} <span class="chat_date">{{$u->total}}</span></h5>
            ...
            @foreach($post_course as $p_c)
                      ...
                      <div class="course-content">
                          <figure class="course-thumbnail">
                              <a href="courses/{{$p_c->id}}"><img src="ezuca/images/{{$p_c->avatar}}" width="150px" height="100px"></a>
                          </figure>
